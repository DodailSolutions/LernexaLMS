      ...
      <main className="flex-grow flex items-center justify-center p-6">
        <div className="bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/60 p-8 rounded-3xl shadow-sm max-w-sm w-full space-y-6">
          <div className="text-center space-y-1.5">
            ...
            <p className="text-xs text-slate-500 leading-relaxed">Sign in to access your course classroom.</p>
          </div>
          ...
          <form className="space-y-4">
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center">
                ...
                <Link href="/login" className="text-[10px] font-semibold text-violet-600 hover:text-violet-700">Forgot?</Link>
              </div>
              <input
                type="password"
                placeholder="••••••••"
          ...
          <div className="text-center text-[10px] text-slate-500 font-medium">
            ...
            <Link href="/register" className="font-bold text-violet-600 hover:text-violet-700">Sign Up</Link>
          </div>
        </div>
      </main>
